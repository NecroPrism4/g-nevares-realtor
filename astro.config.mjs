...
export default defineConfig({
  site: "https://teamnevarezrealestate.com",
  base: "/",
  integrations: [swup({
  ...
  server: {
    allowedHosts: ['teamnevarezrealestate.com', 'www.teamnevarezrealestate.com', 'teamnevarezrealstate.com', 'www.teamnevarezrealstate.com'],
  },
  vite: {
    plugins: [tailwindcss()],
  },
